    ...
    <>
      ...
      <div className="px-4 md:px-6 py-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-3">
          ...
          <div className="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-xs md:text-sm self-start md:self-center">
            AVG. REVIEW TIME <span className="font-semibold">12 min</span>
          </div>
        </div>

        {/* Report Form */}
        <div className="bg-blue-50 rounded-xl shadow p-4 md:p-6">
          <h2 className="text-base md:text-lg font-semibold flex items-center gap-2 text-gray-800 mb-4">
            <i className="fa-solid fa-clipboard-list text-indigo-500"></i>
            Report an Incident
          </h2>
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 px-3 py-2 border rounded-lg bg-white hover:bg-gray-50 w-full sm:w-auto"
                >
                  <i className="fa-solid fa-location-dot text-indigo-500"></i>
                  Use My Location
                </button>
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full sm:w-auto bg-indigo-600 text-white px-5 py-2 rounded-lg hover:bg-indigo-700"
              >
                Submit Report
              </button>
            </div>
