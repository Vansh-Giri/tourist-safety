    ...
    <>
      ...
      <div className="px-4 md:px-6 py-6">
        ...
        <div className="mb-6 text-center md:text-left">
          <h1 className="text-2xl md:text-3xl font-bold flex items-center justify-center md:justify-start gap-2 text-gray-800">
            <i className="fa-solid fa-robot text-indigo-500"></i>
            Emergency Help Chatbot
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Left Side - Chat Window */}
          <div className="md:col-span-2 bg-white rounded-xl shadow p-4 md:p-6 flex flex-col">
            {/* Chat Messages */}
            <div className="flex-1 border rounded-lg p-3 md:p-4 mb-4 bg-gray-50 overflow-y-auto">
              <div className="bg-white border rounded-lg px-3 md:px-4 py-2 shadow w-fit text-gray-800">
                Hi! I’m your safety assistant. How can I help?
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              ...
              <button className="flex items-center justify-center gap-2 px-4 py-2 border rounded-lg bg-red-500 text-white hover:bg-red-600 w-full sm:w-auto">
                <i className="fa-solid fa-bell"></i> SOS
              </button>
            </div>
